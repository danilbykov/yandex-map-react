    ...
    _createClass(YandexMap, [{
            ...
            Object.keys(nextProps).forEach(function (key) {
                switch (key) {
                    ...
                    case 'bounds':
                        ...
                        break;
                    case 'hidden':
                        if (_this2.state.hidden && !nextProps.hidden) {
                            _this2._init();
                            _this2.setState(function (prevState) {
                                return _extends({}, prevState, { hidden: false });
                            });
                        }
                    default:
                        break;
        ...
        value: function _init() {
            if (_api2.default.isAvailible()) {
                ...
                _api2.default.getApiPromise(this._getAPIParams()).then(this._onAPILoad.bind(this)).catch(function (error) {
